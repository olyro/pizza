...
public class Prices {
    ...
    public static List<Item> getExtraItems() {
        ...
        var extras = Arrays.asList(new Item("e1", "Basilikum", es), new Item("e2", "Knoblauch", es),
                new Item("e3", "Oregano", es), new Item("e4", "Ananas", es), new Item("e5", "Artischockenherzen", es),
                new Item("e6", "Bacon", es), new Item("e7", "Barbecuesauce", es), new Item("e8", "Blattspinat", es),
                new Item("e9", "Brokkoli", es), new Item("e10", "Champignons", es), new Item("e11", "Eier", es),
                new Item("e12", "Fetakäse", es), new Item("e13", "Frutti di Mare", es),
                new Item("e14", "Gorgonzola", es), new Item("e15", "Gouda", es), new Item("e16", "Hühnerbrust", es),
                new Item("e17", "Kapern", es), new Item("e18", "Mais", es), new Item("e19", "Mozzarella", es),
                new Item("e20", "Olivenscheiben", es), new Item("e21", "Paprika", es),
                new Item("e22", "Peperoniringe", es), new Item("e23", "Peperoniwurst", es),
                new Item("e24", "Remoulade", es), new Item("e25", "Salami", es), new Item("e26", "Salsa", es),
                new Item("e27", "Sardellen", es), new Item("e28", "Sauce Bolognese", es),
                new Item("e29", "Shrimps", es), new Item("e30", "Spargel", es), new Item("e31", "Tabasco", es),
                new Item("e32", "Taco Beef", es), new Item("e33", "Thunfisch", es), new Item("e34", "Zwiebelringe", es),
                new Item("e35", "frische Champignons", es), new Item("e36", "frische Tomatenscheiben", es),
                new Item("e37", "italienischer Vorderschinken", es), new Item("e38", "mexikanische Jalapeno", es));
        return extras;
    }
    ...
    public static List<MenuItem> getOriginalMenuItems() {
        ...
        var pizzas = Arrays.asList(
                new MenuItem(new Item("p1", "Pizza Margherita",
                        Arrays.asList(new Size(s, 650), new Size(l, 840), new Size(f, 1440), new Size(p, 1790))),
                        "mit Pizzasauce, Mozzarella und Basilikum", extras),
                new MenuItem(new Item("p2", "Pizza New York",
                        Arrays.asList(new Size(s, 700), new Size(l, 900), new Size(f, 1550), new Size(p, 1970))),
                ...
                new MenuItem(new Item("p5", "Pizza Mary",
                        Arrays.asList(new Size(s, 750), new Size(l, 960), new Size(f, 1660), new Size(p, 2150))),
                ...
                new MenuItem(new Item("p16", "Pizza Basic/Wunschpizza",
                        Arrays.asList(new Size(s, 600), new Size(l, 780), new Size(f, 1310), new Size(p, 1610))),
    ...
    public static MenuItem transformMenuItem(MenuItem menuItem) {
        return new MenuItem(
                new Item(menuItem.item.id, menuItem.item.name, menuItem.item.sizes.stream()
                        .map(size -> new Size(size.name, transformPrice(size.price))).collect(Collectors.toList())),
    ...
    private static int transformPrice(int cents) {
        ...
        var withSurcharge = Math.round(cents * 1.15f);
